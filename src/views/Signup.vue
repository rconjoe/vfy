...
export default {
    ...
    data: () => ({
        agreeToTerms: false,
        agreeToTermsRules: [
            value => !!value || 'You must agree to the terms and conditions to create an account.'
        ],
        birthday: '',
        browsers: [
            'Chrome',
        ...
        emailRules: [
            ...
            value => value.indexOf('.') - value.indexOf('@') || 'Email should contain a valid domain',
